...
export default function Resume() {
    ...
    return (
        <>
            <main className="over-hidden particles-container">
                ...
                {/* <!-- ====== about-area-start */}
                {/* ==================================================== --> */}
                <div id="about" className="about-area over-hidden bg-transparent">
                ...
                <div className="education-area  pt-100 bg-transparent">
                    <div className="container">
   ...
   <!-- ====== award-area-start 
==================================================== --> */}
                <div className="award-area over-hidden position-relative z-index11 pt-160 pb-170 bg-transparent">
                    <div className="container">
                        <div className="row">
                            <div className="col-xl-12 col-lg-12  col-md-12  col-sm-12 col-12">
                                <div className="title text-center">
                ...
                <div className="fun-fact-area fun-fact-bg position-relative over-hidden pt-150 pb-120 bg-transparent" data-aos="fade-up"
